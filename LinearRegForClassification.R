...
#Step 1
#Y=Gym [yes=1. no=0]
#X=Gender, Age, Weight, Whr Vector X
...
###Suppose we choose model 0 how we use this for the new data
Age.new=data.frame(Age=c(45, 26, 51))
pr_new_data=predict(m0, Age.new)
pr_new_data
